...
👨‍💻 I am currently working as a **Software Engineer Co-Op** at **Prudential Financial**, where I'm developing **Python**-based automated solutions and modernizing actuarial infrastructure. Previously, I worked as a **Software Engineer Intern** at **JPMorgan Chase**, where my team and I **halved** the initial render time of a client-facing **React Web Application** that serves **1 million monthly users** by utilizing **Next.js’s** general optimizations & its different rendering techniques.
